...
<head>
    ...
    <title>Request Remote Work</title>
  ...
  <tr>
                        ...
                        <img width="60" src="{{asset('assets/logo.png')}}" title="logo" alt="logo">
                                ...
                                <td class="esd-block-button" align="center" >
                                    ...
                                    <a href="{{$url}}" class="es-button" target="_blank" style="background: #3d85c6;width:105px;padding:5px; border-color: #3d85c6; outline: none;text-decoration: none;">See request</a>
                                    </span>
                                 </td>
                                </tr>
                                <tr>
